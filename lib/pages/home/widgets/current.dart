...
import 'package:workout_tracker/models/fitness_program.dart';
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return Program(
                ...
                onTap:
                    _changeProgram, //without the brackets (), because we want to call this when tapped and not when it is built.
              );
            },
